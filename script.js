...
const translations = {
  pt: {
    ...
    diff1_title: "14+ anos de mercado",
    ...
    eng_intro: "Reunimos expertise nacional e internacional acumulada ao longo de mais de 14 anos de atuação na indústria.",
  ...
  en: {
    ...
    diff1_title: "14+ years in the market",
    ...
    eng_intro: "We bring together national and international expertise accumulated over more than 14 years in the industry.",
  ...
  es: {
    ...
    diff1_title: "14+ años en el mercado",
    ...
    eng_intro: "Reunimos experiencia nacional e internacional acumulada a lo largo de más de 14 años en la industria.",
  ...
  fr: {
    ...
    diff1_title: "14+ ans sur le marché",
    ...
    eng_intro: "Nous réunissons une expertise nationale et internationale accumulée sur plus de 14 ans dans l'industrie.",
  ...
  zh: {
    ...
    tab_comex: "外贸服务",
    eng_title: "工程与咨询",
    eng_intro: "我们汇聚了超过14年行业积累的国内外专业知识与经验。",
    eng_1: "生产曲线和或然资源估算",
    eng_2: "确定性和概率性油气体积估算",
    eng_3: "储层和油田开发方案",
    eng_4: "老油田振兴",
  ...
  ar: {
    ...
    eng_intro: "نجمع خبرة وطنية ودولية متراكمة على مدى أكثر من 14 عامًا في الصناعة.",
